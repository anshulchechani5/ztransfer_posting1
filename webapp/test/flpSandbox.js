		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ztransferposting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ztransferposting-display": {
								"semanticObject": "ztransferposting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ztransferposting",
									"url": sap.ui.require.toUrl("ztransferposting")
								}
							}
						}
					}
